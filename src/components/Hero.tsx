...
export const Hero = () => {
  return <section className="min-h-screen flex items-center justify-center px-4 py-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-10 pointer-events-none">
        ...
        <div className="absolute inset-0 bg-gradient-to-tr from-transparent via-primary/10 to-transparent animate-pulse" style={{
        animationDelay: '3s'
      }}></div>
        
        {/* Floating Elements */}
        <div className="absolute top-1/4 left-1/4 w-32 h-32 bg-primary/20 rounded-full blur-2xl animate-bounce" style={{
        animationDuration: '4s'
      }}></div>
        <div className="absolute bottom-1/3 right-1/4 w-24 h-24 bg-secondary/20 rounded-full blur-xl animate-bounce" style={{
        animationDuration: '5s',
        animationDelay: '1s'
      }}></div>
        <div className="absolute top-1/2 right-1/3 w-16 h-16 bg-accent/30 rounded-full blur-lg animate-bounce" style={{
      ...
      <div className="relative z-20 max-w-5xl mx-auto text-center pointer-events-auto">
        ...
        <div className="animate-slide-up grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
          ...
          label: "Languages",
          value: "50+"
        }].map((stat, index) => <GlassCard key={index} variant="hover" className="text-center">
