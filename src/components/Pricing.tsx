...
// File size limits by plan type
export const getFileSizeLimit = (planType: string) => {
  switch (planType?.toLowerCase()) {
    ...
    case 'premium':
    case 'custom':
      return 5120; // 5GB in MB
    default: // Free plan
      return 250; // 250MB in MB
  }
};
...
const monthlyPlans = [{
  ...
  features: ["100 tokens/month", "Video transcription and translation", "25 languages supported", "1GB max file size", "Secure video storage", "Basic support", "Unused tokens don't expire"],
  popular: false,
  ...
  features: ["500 tokens/month", "All Basic features", "1GB max file size", "Priority support", "Custom subtitle styling", "Font, size, position options", "Advanced processing"],
  popular: true,
  ...
  features: ["1,800 tokens/month", "All Pro features", "5GB max file size", "Enhanced processing speed", "Advanced customization options", "Priority processing queue", "Dedicated support"],
  popular: false,
  ...
  features: ["Flexible token allocation", "Unlimited file sizes", "Personalized support", "Custom integrations", "Enterprise SLA", "Dedicated account manager", "Custom pricing negotiation"],
  popular: false,
...
const yearlyPlans = [{
  ...
  tokens: "1,200 tokens",
  description: "Ideal for individual users or small creators",
  features: ["1,200 tokens/year", "Video transcription and translation", "25 languages supported", "1GB max file size", "Secure video storage", "Basic support", "20% yearly savings"],
  popular: false,
  ...
  tokens: "6,000 tokens",
  description: "Suited for growing creators or small businesses",
  features: ["6,000 tokens/year", "All Basic features", "1GB max file size", "Priority support", "Custom subtitle styling", "Font, size, position options", "20% yearly savings"],
  popular: true,
  ...
  description: "Designed for professional users or businesses",
  features: ["21,600 tokens/year", "All Pro features", "5GB max file size", "Enhanced processing speed", "Advanced customization options", "Priority processing queue", "20% yearly savings"],
  popular: false,
